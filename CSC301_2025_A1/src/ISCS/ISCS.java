 ...
 *  the Order, User, and Product
 */
public class ISCS {
    /**
     * The entry point for the ISCS service. Initialize the HTTP server, sets up the request contexts,
     * and configures an executor to handle concurrent service requests
     * @param args args commands line argument. The first argument must be the path to the file
